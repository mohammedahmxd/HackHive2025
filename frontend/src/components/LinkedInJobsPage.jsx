...
export default function LinkedInJobsPage({ onBack }) {
  ...
  const fetchJobs = async () => {
    ...
    try {
      ...
      const response = await fetch(
        "http://localhost:8000/linkedin/jobs/search",
        {
          method: "POST",
          headers: {
  ...
  return (
    ...
    >
      ...
      <div
        style={{ maxWidth: "1400px", margin: "0 auto", width: "100%", flex: 1 }}
      >
        {/* Header */}
        <motion.div
        ...
        {loading && (
          ...
          >
            <div style={{ marginBottom: "1rem" }}>
              Searching LinkedIn for {selectedCareer?.title || "jobs"}...
            </div>
        ...
        {!loading && !error && jobs.length === 0 && (
          ...
          >
            No jobs found for {selectedCareer?.title || "this career path"}.
